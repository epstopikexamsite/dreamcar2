            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="relative h-80 md:h-full w-full rounded-lg overflow-hidden shadow-lg min-h-[350px]">
                        <Image
                            src="https://placehold.co/600x400.png?text=Showroom+TimeCarsAuto"
                            alt="Không gian showroom TimeCarsAuto"
                            fill
                    ...
                    <div>
                        ...
                        <div className="text-foreground/80 space-y-4 text-lg">
                            <p>
                                Được thành lập vào ngày <strong>08/11/2021</strong> bởi nhà sáng lập tâm huyết <strong>Trần Mạnh Tuấn</strong>, TimeCarsAuto đã nhanh chóng khẳng định vị thế của mình trên thị trường ô tô đã qua sử dụng.
                            </p>
                            <p>
        ...
        <section className="py-16">
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="text-center mb-12">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Chúng tôi cam kết mang đến sự an tâm tuyệt đối qua những giá trị nền tảng đã làm nên thương hiệu TimeCarsAuto.</p>
                </div>
        ...
        <section className="py-16 bg-primary/5">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                        Những con người tận tâm đứng sau thành công của TimeCarsAuto, luôn sẵn sàng phục vụ và mang đến cho bạn những trải nghiệm tốt nhất.
                    </p>
                </div>
